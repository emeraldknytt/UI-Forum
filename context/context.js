...
export const SOCAIL_MEDIA_Provider = ({ children }) => {
  const SOCIAL_MEDIA_DAPP = "UI-Forum";
  ...
  const CREATE_GROUP = async () => {
    try {
      ...
      const GROUP_NAME_1 = "CSC";
      const GROUP_DES_1 =
        "The best department in all of University of Ibadan";
