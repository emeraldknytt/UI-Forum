  ...
  return (
    <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3 new_margin">
      ...
      <div class="card-body p-0 mb-3 rounded-3 overflow-hidden">
        <a class="">
          <video controls loop src={post.postURL} class="float-right w-100"></video>
        </a>
      </div>
      ...
      <div class="card-body d-flex align-items-baseline p-0">
        <a
          ...
          class="emoji-bttn d-flex align-items-baseline cursor-pointer fw-600 text-blue font-xsss me-2"
        >
