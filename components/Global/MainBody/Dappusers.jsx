        ...
        <>
          ...
          <div class="card-body d-flex align-items-center pt-0 ps-4 pe-4 pb-4">
            <a
              ...
              class="p-2 lh-20 w100 bg-primary-gradiant cursor-pointer me-2 text-white text-center font-xssss fw-600 ls-1 rounded-xl"
            >
              Follow
            </a>
            <a
              href="#"
              class="p-2 lh-20 w100 cursor-pointer bg-grey text-grey-800 text-center font-xssss fw-600 ls-1 rounded-xl"
            >
              Verified
            </a>
          </div>
