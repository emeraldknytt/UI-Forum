  ...
  return (
    <div class="nav-top">
      <a onClick={() => functionName()}>
        {/* <a href="/"> */}
        <img src="images/UI-logo-full-cr.png" alt="UI-Logo" class="display1-size me-3 ms-0"/>      
        <span class="d-inline-block fredoka-font ls-3 fw-600 text-white font-xxl logo-text mb-0">
          Forum
        </span>
      </a>
      <a
